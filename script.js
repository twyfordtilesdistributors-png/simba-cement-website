...
// Replace the temporary text mark with the logo supplied by the site owner.
...
.brand-mark.actual-logo,.brand-mark{padding-left:0!important;display:flex!important;align-items:center!important;width:245px!important;height:64px!important;line-height:1!important}
.brand-mark:before{display:none!important}
.brand-mark .site-logo{display:block;width:245px;height:64px;object-fit:contain;object-position:left center}
@media(max-width:700px){.brand-mark.actual-logo,.brand-mark{width:190px!important;height:52px!important}.brand-mark .site-logo{width:190px;height:52px}}
`;
